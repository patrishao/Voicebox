...
<body>
    ...
    <p class="title">+ Create a new post</p>
    ...
    <div class="container">
        ...
        <div class="contents">
            ...
            <?php include 'backend/postsdata.php' ?>
            ...
            <form action="create-post.php" method="post" enctype="multipart/form-data">
                <div class="post-title">
                    ...
                    <textarea placeholder=" Post Title" name="postTitle" class="postTitle"></textarea>
                ...
                <div class="img-holder">
                    <input type="file" name="imgFile" id="fileAttach" accept="image/png, image/jpeg, image/gif" onChange="loadFile(event)" hidden />
                    ...
                    <div class="fileAttachment" id="" onclick="triggerClickGif()">
                        ...
                        <img src="img/default-pic.jpg" class="image" id="imgFile" />
                    </div>
                ...
                <div class=" textarea-container">
                    <textarea placeholder="Write a text...(optional)" class="post-text" name="postText"></textarea>
                ...
                <label class="chooseTopic">
                    ...
                    <select class="chooseTopic hover" placeholder="Choose the topic" name="postTopic">
                        <option value="" disabled selected class="disabled">Choose a topic</option>
