...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/specific-post.css">
    ...
    <div class="container" id="container">
        ...
        <main id="main">
            ...
            if (isset($_GET['search'])) {
                ...
                $searchedWord =  mysqli_real_escape_string($connection, $searchedWord);
            }

            // getting the posts based on the keyword search

            // finding simlar words from the posts title, text or category
            $postQuery = "SELECT * FROM posts  WHERE postTitle LIKE '%$searchedWord%' OR postText LIKE '%$searchedWord%'  OR postCategory LIKE '%$searchedWord%' ORDER BY postDate DESC  ";
            ...
            // getting the users of the post
            $postuserQuery = "SELECT * FROM users INNER JOIN posts ON users.userID = posts.postUserID WHERE postTitle LIKE '%$searchedWord%' OR postText LIKE '%$searchedWord%'  OR postCategory LIKE '%$searchedWord%' ORDER BY postDate DESC  ";
            $select_all_userposts_query = mysqli_query($connection, $postuserQuery);

            if (!$select_all_userposts_query) {
                echo mysqli_error($connection);
            }
            ...
            ?>
                ...
                <article class="all-posts">
                    ...
                    <?php while ($row2 = mysqli_fetch_assoc($select_all_userposts_query)) {


                        // $select_all_postUsers_query = mysqli_query($connection, $selecPostUsersQuery);
                        ...
                        $usernamePoster = htmlspecialchars($row2['userName']);
                        $namePoster = htmlspecialchars($row2['nickname']);
                        $userProfPhoto = $row2['userProfPhoto'];
                            ...
                            <div class="upper">
                                ...
                                <div class="contents">
                                    ...
                                    <div class="user">
                                        ...
                                        <h1 class="name-post"> <?php echo $usernamePoster ?> <span class="square"> &#x25a0 </span> <time class="time timeago" datetime=" <?php echo $postDate->format(DateTime::ATOM) ?>"> </time> </h1>

                                        <h2 class="username-post"><?php echo '@' . $namePoster ?></h2>
            ...
            <?php } else { ?>
                <div class="noposts">
                    <p class="nopost">There are no posts about this yet! Why don't you be the first one to post about it? </p>
                </div>
            <?php } ?>
                ...
                <article class="search">
                    ...
                    <form class="" id="searchForm" method="get" action="searched-post.php">
                        ...
                        <div class="searchbar-container">
                            ...
                            <button type="submit" form="searchForm" class="search-button" name="search"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 25 23" fill="none">
