...
<body>
    ...
    <div class="container" id="container">
        ...
        <main id="main">
            ...
            $postQuery = "SELECT * FROM posts WHERE postCategory = '$categoryName' ORDER BY postDate DESC";
            ...
            $postuserQuery = "SELECT * FROM users INNER JOIN posts ON users.userID = posts.postUserID WHERE postCategory = '$categoryName' ORDER BY postDate DESC";
            ...
            ?>
                ...
                <article class="all-posts">
                    ...
                    while ($row = mysqli_fetch_assoc($select_all_userposts_query)) {
                        ...
                        $userID = $row['userID'];
                        $usernamePoster = $row['userName'];
                        $namePoster = $row['nickname'];
                                ...
                                <div class="contents">
                                    ...
                                    <a href="post-page.php?p_id=<?php echo $postID ?>">
                                        <div class="post-content">
                                            ...
                                            if ($image != null) { ?>
                                                <img class="post-img" src="img/default-pic.jpg" />
