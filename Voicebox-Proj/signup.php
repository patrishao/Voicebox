...
<body>
    ...
    <div class="container">
        ...
        <div class="headings">
            ...
            <p class="sub-heading">We're looking forward for you to join us.</p>
        </div>
        ...
        <article>
            ...
            <div class="center-form">
                ...
                <form action="signup.php" method="post">
                    ...
                    <input type="text" name="date" value="<?php echo date('Ymd')  ?>" hidden />


                    <div class="password-container">
                        <label class="label" for="password">Password</label> <br>
                        <input class="password input" type="password" name="password" placeholder="Enter password" id="password1" /> <br>
                        <i class="bi bi-eye-slash togglePass" id="togglePassword1"></i>
                    </div>

                    <div class="password-container">
                        <label class="label" for="confirm-password">Confirm password</label> <br>
                        <input class="password input" type="password" name="confirm-password" placeholder="Enter password" id="password2" /> <br>
            ...
            <p class="conditions">By clicking Join now, you agree to our Terms, Data Policy and Cookies Policy.</p>
